        ...
        <div className="container mt-5">
            <div className="row row-cols-1 row-cols-md-2">
                ...
                <div className="col my-auto">
                    ...
                    <p className="text-justify">Good bye 2021 and welcome to 2022. I think this year will be life changing year for me. Because of I am getting to set my mission. This year I have been taken a challenge to develope ourselves explore our journey.</p>
            ...
            <div className="row row-cols-1 row-cols-md-3 g-4 my-5 py-5">
                <div className="col">
                    ...
                    <div className="card-body">
                        <h5 className="card-title text-center fs-3">Mission</h5>
                ...
                <div className="col">
                    ...
                    <div className="card-body">
                        <h5 className="card-title text-center fs-3">Vision</h5>
                ...
                <div className="col">
                    ...
                    <div className="card-body">
                        <h5 className="card-title text-center fs-3">Goals</h5>
